...
public class MainMenu {
    ...
    private void showGameModeSelection() {
        ...
        selectionFrame.setSize(1100, 600);
        ...
        JButton hardButton = createButton("Hard Bot", new Color(200, 150, 0));
        hardButton.addActionListener(e -> {
            selectionFrame.dispose();
            new GameFrame(true, 2);
        });

        JButton impossibleButton = createButton("Impossible Bot", new Color(150, 0, 0));
        impossibleButton.addActionListener(e -> {
            selectionFrame.dispose();
            new GameFrame(true, 3);
        });
        ...
        modePanel.add(Box.createVerticalStrut(20));
        modePanel.add(impossibleButton);
        modePanel.add(Box.createVerticalStrut(10));
